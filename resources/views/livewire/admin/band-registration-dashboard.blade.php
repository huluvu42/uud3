                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($stats['total_bands']) }}
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($stats['pending']) }}
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            @if (count($overdueRegistrations) > 0)
                <div class="rounded-lg border-l-4 border-red-400 bg-white shadow">
                    <div class="border-b border-gray-200 bg-red-50 px-6 py-4">
                        ...
                        <p class="mt-1 text-sm text-red-700">Diese Bands haben vor mehr als 14 Tagen einen Link
                            erhalten</p>
                    </div>
                                        ...
                                        <div class="min-w-0 flex-1">
                                            ...
                                            <div class="text-sm text-gray-500">
                                                ...
                                                @if ($overdue['manager_email'])
                                                    <span class="mx-2">•</span>
                                                    <span
                                                        class="font-mono text-xs">{{ $overdue['manager_email'] }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
