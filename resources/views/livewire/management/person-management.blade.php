{{-- resources/views/livewire/management/person-management.blade.php - OPTIMIERTE VERSION --}}
...
<div class="container mx-auto px-4 py-8">
        ...
        @if (session()->has('success'))
            ...
            @if ($showCreateForm || $showEditForm)
                <div class="fixed inset-0 z-50 h-full w-full overflow-y-auto bg-gray-600 bg-opacity-50"
                    wire:keydown.escape="cancelPersonForm">
                    <div
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div>
                                        ...
                                        <select wire:model.live="group_id" wire:loading.attr="disabled"
                                            wire:target="updatedGroupId"
                                            class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.live="band_id" wire:loading.attr="disabled"
                                            wire:target="updatedBandId"
                                            class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <div class="mt-4">
                                    <label class="mb-1 block text-sm font-medium text-gray-700">Verantwortliche Person
                                        (für Gäste)</label>
                            ...
                            <div class="mb-6 space-y-3">
                                <label
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500">Person ist derzeit beim Festival anwesend
                                        </div>
                                    </div>
                                </label>
                                ...
                                <label
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500">Person darf als verantwortliche Person für
                                            Gäste eingetragen werden</div>
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="mt-6 flex justify-end space-x-4 border-t border-gray-200 pt-4">
                                <button wire:click="cancelPersonForm" wire:loading.attr="disabled"
                                    wire:loading.class="opacity-50"
                                    class="rounded border border-gray-300 px-4 py-2 text-gray-600 transition-colors duration-200 hover:bg-gray-50">
                                    Abbrechen
                                </button>
                                @if ($showCreateForm)
                                    <button wire:click="savePerson(true)" wire:loading.attr="disabled"
                                        wire:loading.class="opacity-50 cursor-not-allowed" wire:target="savePerson"
                                        class="rounded bg-blue-500 px-4 py-2 text-white transition-colors duration-200 hover:bg-blue-600">
                                        <span wire:loading.remove wire:target="savePerson">Speichern & Weiter</span>
                                        <span wire:loading wire:target="savePerson">Speichern...</span>
                                    </button>
                                @endif
                                <button wire:click="{{ $showCreateForm ? 'savePerson(false)' : 'updatePerson' }}"
                                    wire:loading.attr="disabled" wire:loading.class="opacity-50 cursor-not-allowed"
                                    wire:target="{{ $showCreateForm ? 'savePerson' : 'updatePerson' }}"
            ...
            <!-- Gäste Modal (Optimiert) -->
            @if ($showGuestsModal && $selectedPersonForGuests)
                <div class="fixed inset-0 z-50 h-full w-full overflow-y-auto bg-gray-600 bg-opacity-50"
                    wire:keydown.escape="closeGuestsModal">
                    <div
                                            ...
                                            <tr class="transition-colors duration-150 hover:bg-gray-50">
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4">
                                                    <button wire:click="toggleGuestPresence({{ $guest->id }})"
                                                        ...
                                                        <span wire:loading
                                                            wire:target="toggleGuestPresence">Ändere...</span>
                                                    </button>
                                                </td>
                                                <td class="whitespace-nowrap px-6 py-4">
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 text-sm">
                                                    <button wire:click="editPerson({{ $guest->id }})"
                                                        ...
                                                        wire:target="editPerson"
                                                        class="font-medium text-blue-600 transition-colors duration-200 hover:text-blue-800">
                                                        <span wire:loading.remove
                                                            wire:target="editPerson">Bearbeiten</span>
                                                        <span wire:loading wire:target="editPerson">...</span>
                                                    </button>
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="mt-6 flex justify-end">
                            <button wire:click="closeGuestsModal" wire:loading.attr="disabled"
                                wire:loading.class="opacity-50"
                                class="rounded bg-gray-500 px-4 py-2 text-white transition-colors duration-200 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500">
                                Schließen
                            </button>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Einfache Suchfeld-Funktionalität mit Livewire
            ...
            // Weitere bestehende JavaScript-Funktionen...
            // Debouncing für kritische Aktionen
            let clickTimeout = null;
            const CLICK_DELAY = 1000; // 1 Sekunde

            // Verhindere Spam-Klicks auf kritische Buttons
            document.addEventListener('click', function(e) {
                const criticalButtons = [
                    '[wire\\:click*="togglePresence"]',
                    '[wire\\:click*="toggleGuestPresence"]',
                    '[wire\\:click*="savePerson"]',
                    '[wire\\:click*="updatePerson"]',
                    '[wire\\:click*="deletePerson"]'
                ];

                const isCriticalButton = criticalButtons.some(selector =>
                ...
                if (isCriticalButton) {
                    if (clickTimeout) {
                        e.preventDefault();
                        e.stopPropagation();
                        showTemporaryMessage('Bitte warten Sie einen Moment...', 'warning');
                        return false;
                    }
            ...
            // Event Listener für Gruppen-Auswahl (optimiert)
                    ...
                    if (selectedOption && selectedOption.value) {
                        ...
                        for (let day = 1; day <= 4; day++) {
                            ...
                            if (voucherInput && voucherValue) {
                                ...
                                updates.push(() => voucherInput.dispatchEvent(new Event('input')));
                            }
                        }
                        ...
                        for (let day = 1; day <= 4; day++) {
                            ...
                            if (backstageCheckbox && backstageValue) {
                                ...
                                updates.push(() => backstageCheckbox.dispatchEvent(new Event('change')));
                            }
                        }
                        ...
                        if (canHaveGuestsCheckbox && canHaveGuestsValue) {
                            ...
                            updates.push(() => canHaveGuestsCheckbox.dispatchEvent(new Event('change', {
                                bubbles: true
                            })));
                        }
        ...
        function showKeyboardShortcutMessage(message) {
            showTemporaryMessage(`⌨️ ${message}`, 'info');
        }

        function showGroupLoadedMessage(groupName) {
            showTemporaryMessage(`✓ Einstellungen von "${groupName}" geladen`, 'success');
        }
        ...
        function clearNameFields() {
            ...
            // Fokus auf Vorname-Feld für bessere UX
        ...
        function resetGroupValues() {
            // Voucher-Felder und Backstage-Checkboxen zurücksetzen
            for (let day = 1; day <= 4; day++) {
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" wire:model.live.debounce.300ms="search" wire:focus="focusSearch"
                        ...
                        wire:loading.class="bg-gray-50" wire:target="updatedSearch" id="search-input"
                        autocomplete="off" ondblclick="@this.call('clearSearch')">
            ...
            <div>
                ...
                <div class="space-y-2">
                    <select wire:model.live="filterType"
                        class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        wire:loading.attr="disabled" wire:target="updatedFilterType">
                    ...
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" wire:model.live="showBandMembers"
                            ...
                            wire:loading.attr="disabled" wire:target="updatedShowBandMembers">
            ...
            <div>
                ...
                <button wire:click="createPerson" wire:loading.attr="disabled"
                    wire:loading.class="opacity-50 cursor-not-allowed" wire:target="createPerson"
                    class="w-full rounded bg-green-500 px-4 py-2 text-white transition-colors duration-200 hover:bg-green-600">
                    <span wire:loading.remove wire:target="createPerson">Person hinzufügen</span>
                    <span wire:loading wire:target="createPerson">Lade...</span>
                </button>
            </div>
        </div>
    </div>
                    ...
                    <div class="{{ $person->isGuest() ? 'bg-blue-50 border-blue-200' : '' }} rounded-lg border border-gray-200 p-4 transition-colors duration-150 hover:bg-gray-50"
                        ...
                        <div class="grid grid-cols-1 gap-4 xl:grid-cols-7">
                                ...
                                <div class="text-xs">
                                    @if ($person->responsibleFor->count() > 0)
                                        <button wire:click="showGuests({{ $person->id }})"
                                            ...
                                            <span wire:loading.remove wire:target="showGuests">
                                                {{ $person->responsibleFor->count() }}
                                                {{ $person->responsibleFor->count() === 1 ? 'Gast' : 'Gäste' }}
                                            </span>
                                            <span wire:loading wire:target="showGuests">Lade...</span>
                                        </button>
                                    @else
                                        <span
                            ...
                            <div class="xl:col-span-1">
                                ...
                                <div class="space-y-2">
                                    <button wire:click="editPerson({{ $person->id }})" wire:loading.attr="disabled"
                                        wire:loading.class="opacity-50" wire:target="editPerson"
                                        ...
                                        <span wire:loading.remove wire:target="editPerson">Bearbeiten</span>
                                        <span wire:loading wire:target="editPerson">...</span>
                                    </button>
                                    ...
                                    <button wire:click="deletePerson({{ $person->id }})"
                                        ...
                                        <span wire:loading.remove wire:target="deletePerson">Löschen</span>
                                        <span wire:loading wire:target="deletePerson">...</span>
                                    </button>

                                    {{-- Kennzeichen Button --}}
                                    <button wire:click="showVehiclePlates({{ $person->id }})"
                                        wire:loading.attr="disabled" wire:loading.class="opacity-50"
                                        wire:target="showVehiclePlates"
                                        ...
                                        <span wire:loading.remove wire:target="showVehiclePlates">
                                            🚗
                                            {{ $person->vehiclePlates->count() > 0 ? $person->vehiclePlates->count() : '' }}
                                        </span>
                                        <span wire:loading wire:target="showVehiclePlates">...</span>
                                    </button>
                                </div>
                            </div>
                        </div>
